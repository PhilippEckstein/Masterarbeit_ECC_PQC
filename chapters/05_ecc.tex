...
\begin{beispiel}
    Es wird erneut das Beispiel aus Kapitel 4 aufgegriffen. Sei $G=E(\mathbb{F}_{17})$, wobei $E$ gegeben ist durch $y^2=x^3+2x+2$. Sei $P=(0,6)$ und $Q=(3, 16)=kP$. nach dem Satz von Hasse \ref{def:hasse-schranke} kann eine obere Schranke ausgerechnet werden
    \[ 
    |\#E(\mathbb{F}_{17})-17-1 |\leq 2\sqrt 17
    \],
    also die Ordnung ist 26. Daher sei $m=\lceil \sqrt{26}\rceil=6$. Die Punkte $iP$ für $1\leq i< 6$ sind
    \[
